export declare const TOOL_ID: "agent-cfml-check";
export declare const TOOL_VERSION: "0.1.1";
export declare const PROFILE_ID: "cfml-structure-v1";
...
export interface Finding {
    code: "UNEXPECTED_CLOSE" | "MISMATCHED_CLOSE" | "UNCLOSED_TAG" | "INVALID_BRANCH" | "UNTERMINATED_STRING" | "UNTERMINATED_COMMENT" | "UNBALANCED_DELIMITER";
    message: string;
